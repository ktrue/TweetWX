 ...
 * Globals and utilities for OAuth Examaples package
 ...
 Version 1.00 - 11-Jun-2010 - Initial relase
 Version 1.01 - 13-Jun-2013 - fixes for API 1.1 using SSL only
 Version 1.02 - 18-Jan-2014 - fixes for OAuth using SSL only
 
 */

// you can leave these two settings alone if you like.  They are for TweetWX script from SaratogaWX
//
// If you choose to define your own app using http://twitter.com/oauth_clients/new then
// replace the two values below with the values given by twitter for the customer_key and customer_secret.
define('OAUTH_CONSUMER_KEY', 'fJkVCHCtIT0drcp18Yr7Ug');
define('OAUTH_CONSUMER_SECRET', 'DsdVaBnI9jeF39tN5PQPdZeV0QbkA70os74HbzL5Ws');
//
//
// ------------ No changes are needed below ----------------------------------
$progname = $argv[0];
$debug = 0; // Set to 1 for verbose debugging output BUT DON'T DO IN PRODUCTION as your keys will be visible
 ...
 */
function do_get($url, $port=443, $headers=NULL)
{
